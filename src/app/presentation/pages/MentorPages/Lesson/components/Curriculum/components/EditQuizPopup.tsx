...
const AddQuizPopup: React.FC<QuizProps> = ({ onClose, addQuiz,editQuizData,saveQuizToLesson,editQuizToWhichLesson }) => {
  const [questionList, setQuestionList] = useState<any[]>(editQuizData.quiz)
  ...
  const handleSaveQuiz = () => {
    saveQuizToLesson(questionList,editQuizToWhichLesson.id)
    onClose()
  }
        ...
        <div className="bg-white border p-8 w-4/5 h-2/3 rounded shadow-lg overflow-y-auto">
          <div className={"flex flex-col justify-between "} >
            <div className="w-full flex justify-between align-center">
              <div>
                <span>Quiz Düzenle (Quiz bilgileri)</span>
              </div>
