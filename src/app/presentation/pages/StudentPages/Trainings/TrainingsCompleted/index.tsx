...
import TrainingsCompletedPage from './TrainingsCompletedPage';
...
const FakePropositions = [
    <TrainingsCompletedPage key={"1"} image={"https://demo.anibalbilisim.com/digithane/egitim/unity.png"}
        title={"Unity Oyun Geliştirmeyi Oyun Geliştirerek Öğren"}/>,
    <TrainingsCompletedPage key={"2"} image={"https://demo.anibalbilisim.com/digithane/egitim/etik.png"}
    title={"Etik Hackerlik ve Siber Güvenlik"} />,
    <TrainingsCompletedPage key={"3"} image={"https://demo.anibalbilisim.com/digithane/egitim/girisim.png"}
    title={"Girişimcilik - İş Geliştirme ve Dijital Pazarlama Eğitimi"}/>,
    <TrainingsCompletedPage key={"4"} image={"https://demo.anibalbilisim.com/digithane/egitim/mobil.png"}
    title={"Mobil Oyun Yapımı Eğitimi - Android"}/>,
    <TrainingsCompletedPage key={"5"} image={"https://demo.anibalbilisim.com/digithane/egitim/kosgeb.png"}
