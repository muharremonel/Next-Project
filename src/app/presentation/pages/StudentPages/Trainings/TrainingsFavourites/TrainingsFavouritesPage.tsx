...
import { Start, Filled } from "@/svgImports";
...
const TrainingsFavouritesPage = ({title, percentage, image}: TrainingsPageProps) => {
    return (
        <div className={"w-full flex shadow-xl md:flex-row flex-col bg-white mb-8 p-5 rounded-xl gap-8"}>
            ...
            <div className={"flex flex-col justify-between w-full"}>
                    <div className={"w-full mb-5 flex justify-between md:text-3xl text-2xl text-grey"}>
                        {title}
                        <span><Filled/></span>
                    </div>
...
export default TrainingsFavouritesPage